...
const trendingCourses = [
    { title: 'Machine Learning Specialization', instructor: 'Andrew Ng', category: 'AI', rating: 4.9, reviews: 25000, price: '$49', image: 'https://images.unsplash.com/photo-1677442136019-21780ecad995' },
    { title: 'Full Stack Web Development', instructor: 'Angela Yu', category: 'Web Dev', rating: 4.8, reviews: 18000, price: '$39', image: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085' },
    { title: 'Data Science Professional Certificate', instructor: 'IBM', category: 'Data Science', rating: 4.7, reviews: 15000, price: '$59', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71' },
    { title: 'UX/UI Design Bootcamp', instructor: 'Sarah Chen', category: 'Design', rating: 4.9, reviews: 12000, price: '$45', image: 'https://images.unsplash.com/photo-1561070791-2526d30994b5' }
];

const featuredCourses = [
    { title: 'Python for Everybody', instructor: 'Dr. Charles Severance', category: 'Programming', rating: 4.8, reviews: 50000, price: '$29', image: 'https://images.unsplash.com/photo-1526379095098-d400fd0bf935' },
    { title: 'Digital Marketing Masterclass', instructor: 'Neil Patel', category: 'Marketing', rating: 4.7, reviews: 22000, price: '$39', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f' },
    { title: 'iOS App Development', instructor: 'Angela Yu', category: 'Mobile', rating: 4.8, reviews: 16000, price: '$49', image: 'https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c' },
    { title: 'Financial Markets', instructor: 'Yale University', category: 'Finance', rating: 4.9, reviews: 35000, price: 'Free', image: 'https://images.unsplash.com/photo-1579621970563-ebec7560ff3e' }
];
